...
const WORKER_COUNT = 1; // Single worker for serverless
const JOB_TIMEOUT = 10000; // 10 seconds timeout per job
const MAX_RETRIES = 3;

// Process a single payment with timeout and retries
async function processPayment(paymentData, attempt = 1) {
